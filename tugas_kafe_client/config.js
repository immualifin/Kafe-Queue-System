...
const API_CONFIG = {
  ...
  SERVER_URL: "http://192.168.1.25/tugas_kafe_server",
  ...
  ENDPOINTS: {
    ...
    MENUS: {
      ...
      UPDATE: "/api/menus/update.php?id={id}",
      DELETE: "/api/menus/delete.php?id={id}",
    },
    ORDERS: {
      READ: "/api/orders/read.php",
      CREATE: "/api/orders/create.php",
      UPDATE_STATUS: "/api/orders/update_status.php?id={id}",
    },
  },
};
